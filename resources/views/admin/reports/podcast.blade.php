...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-xl shadow-sm">
            <div class="text-center">
                <div class="text-3xl font-bold text-blue-600">{{ $podcasts->count() }}</div>
                <p class="text-sm text-gray-600 mt-2">Total Podcast</p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            <div class="text-center">
                <div class="text-3xl font-bold text-green-600">
                    {{ $podcasts->where('status_verifikasi', 'disetujui')->count() }}
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            <div class="text-center">
                <div class="text-3xl font-bold text-red-600">
                    {{ $podcasts->where('status_verifikasi', 'ditolak')->count() }}
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-bold text-gray-800">Detail Laporan Podcast</h2>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-sm">{{ Str::limit($podcast->keterangan, 40) }}</td>
                        ...
                        <td class="py-3 px-4 text-sm">{{ $podcast->verifikasi ?? '-' }}</td>
                    </tr>
                    @empty
                    <tr>
